...
export const ANCHORED_GUARDS: readonly AnchoredGuard[] = [
  ...
  { pattern_key: "state_update",
    regex: /^(?:update|set)\s+(?:my\s+)?(?:state|soma|heat|reach|weight|acuity|presence|warmth|stillness|density|perimeter|mood)\b/i,
    note: "H8: soma/state update anchored at start to beat companion_note_add's 'for cypher/drevan/gaia' substring" },
