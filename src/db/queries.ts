...
export const SUPERSEDABLE_CLOSE_KINDS = ["auto_stale", "empty", "machine_opened", "consolidation", "shutdown"] as const;
...
export const CALLER_CLOSE_KINDS = ["consolidation", "shutdown"] as const;
