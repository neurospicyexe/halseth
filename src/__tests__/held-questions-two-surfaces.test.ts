...
function stateWith(questions: Array<{ id: string; question: string; voiced: boolean }>): MindState {
  return {
    ...
    world: { home_recent: [], club: null, commons: [], shelf: [], collection: { forage: [], media: [] }, forage: { pool: [], active: [] }, listens: [], motifs: { active: [], resurrection_candidates: [] }, sol: null, creatures: [], imps_active: [], watching: [] },
